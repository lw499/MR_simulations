...
myfunc = function(m)
{
  ...
  model=function(beta){ 
    ...
    dat_obs[,1] = dat_obs[,1]/(mydat$pred_obs_0*mydat$pred_obs_1*mydat$pred_obs_2*mydat$pred_obs_3); 
    dat_obs[,2] = dat_obs[,2]/(mydat$pred_obs_0*mydat$pred_obs_1*mydat$pred_obs_2*mydat$pred_obs_3)
...
write.csv(test2,"DR_BHT_opt.csv")
